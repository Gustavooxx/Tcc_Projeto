...
(nome_completo, email, senha, cpf, telefone, estado, sexo,tipo_sanguineo, origem,cidade)
VALUES
(?, ?, MD5(?), ?, ?, ?, ?, ?, ?, ?);
`
    const [info] = await connection.query(comando, [novoCadastro.nome_completo, novoCadastro.email,
         novoCadastro.senha, novoCadastro.cpf, novoCadastro.telefone, novoCadastro.estado,
          novoCadastro.sexo,novoCadastro.tipo_sanguineo, novoCadastro.origem, novoCadastro.cidade]);
